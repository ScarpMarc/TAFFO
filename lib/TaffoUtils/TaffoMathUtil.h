...
{
  static const auto names = llvm::SmallVector<std::string, 17>({"sin", "cos", "_ZSt3cos", "_ZSt3sin", "asin", "acos", "abs", "fabsf", "ceil", "trunc", "copysign", "floor", "exp", "log", "log10", "log2", "log1p"});
  for (auto &name : names) {
